...
<!-- Mirrored from coderthemes.com/adminto/layouts/confirm-mail.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Nov 2025 04:58:39 GMT -->
<head>
    <meta charset="utf-8" />
    <title>Confirm Mail | Adminto - Responsive Bootstrap 5 Admin Dashboard</title>
        ...
        <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
            <div class="col-xxl-3 col-lg-5 col-md-6">
                ...
                <div class="card overflow-hidden text-center p-xxl-4 p-3 mb-0">
                    ...
                    <img src="assets/images/png/mail-confirm.png" alt="img" width="86" class="mx-auto d-block">

                    <p class="text-muted fs-14 mt-2"> A email has been send to <b>youremail@domain.com</b>.
                        Please check for an email from company and click on the included link to
                        reset your password. </p>

                    <a href="index.php" class="btn d-block btn-primary mt-3">Back to
                        Home</a>
                </div>
