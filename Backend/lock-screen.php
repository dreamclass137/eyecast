...
<!-- Mirrored from coderthemes.com/adminto/layouts/lock-screen.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Nov 2025 04:58:39 GMT -->
<head>
    <meta charset="utf-8" />
    <title>Lock Screen | Adminto - Responsive Bootstrap 5 Admin Dashboard</title>
        ...
        <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
            <div class="col-xxl-3 col-lg-5 col-md-6">
                ...
                <div class="card overflow-hidden text-center p-xxl-4 p-3 mb-0">
                    ...
                    <form action="https://coderthemes.com/adminto/layouts/index.php" class="text-start mb-3">
                        <div class="mb-3">
