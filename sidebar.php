            ...
            <div class="dropdown-center">
                <a class="topbar-link dropdown-toggle text-reset drop-arrow-none px-2" data-bs-toggle="dropdown">
                    ...
                    <span class="d-flex justify-content-center gap-1 sidenav-user-name my-2">
                        <span>
                            <span class="mb-0 fw-semibold lh-base fs-15">eye_cast</span>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarProduct">
                    <ul class="sub-menu">
						...
						<li><a href="add-product-variation.php" class="side-nav-link sub-item">Add Product Variation</a></li>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarColour">
                    <ul class="sub-menu">
                        <li><a href="add-colour.php" class="side-nav-link sub-item">Add Colour</a></li>
                        <li><a href="manage-colour.php" class="side-nav-link sub-item">Manage Colour</a></li>
                    </ul>
                </div>
            </li>
            ...
            <!--<li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarShape">
                    <ul class="sub-menu">
                        <li><a href="add-users.php" class="side-nav-link sub-item">Add Users</a></li>
			...
			<!-- Addresses -->
            <li class="side-nav-item">
                <a class="side-nav-link collapsed" data-bs-toggle="collapse" href="#sidebarAddress" aria-expanded="false">
                    <span class="menu-icon"><i class="ti ti-tag"></i></span>
                    <span class="menu-text">Addresses</span>
                    <span class="menu-arrow"><i class="feather icon-feather-chevron-right"></i></span>
                </a>
                <div class="collapse" id="sidebarAddress">
                    <ul class="sub-menu">
